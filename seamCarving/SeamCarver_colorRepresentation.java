...
public class SeamCarver {
    ...
    public SeamCarver(Picture picture) {
        ...
        for (int y = 0; y < height; y++)
            for (int x = 0; x < width; x++) {
                ...
                // r[y][x] = picture.get(x, y).getRed();
                // g[y][x] = picture.get(x, y).getGreen();
                // b[y][x] = picture.get(x, y).getBlue();
            }
    ...
    public  double energy(int x, int y) {
        ...
        // return (r[y][x+1] - r[y][x-1]) * (r[y][x+1] - r[y][x-1])  +
        //     (g[y][x+1] - g[y][x-1]) * (g[y][x+1] - g[y][x-1])  +
        //     (b[y][x+1] - b[y][x-1]) * (b[y][x+1] - b[y][x-1])  +
        //     (r[y+1][x] - r[y-1][x]) * (r[y+1][x] - r[y-1][x]) +
        //     (g[y+1][x] - g[y-1][x]) * (g[y+1][x] - g[y-1][x]) +
        //     (b[y+1][x] - b[y-1][x]) * (b[y+1][x] - b[y-1][x]);
    }
    ...
    public    void removeHorizontalSeam(int[] seam) {
        ...
        // int[][] newR = new int[height - 1][width];
        // int[][] newG = new int[height - 1][width];
        // int[][] newB = new int[height - 1][width];
    ...
    public    void removeVerticalSeam(int[] seam) {
        ...
        // int[][] newR = new int[height][width - 1];
        // int[][] newG = new int[height][width - 1];
        // int[][] newB = new int[height][width - 1];
